...
const char * const BITCOIN_CONF_FILENAME = "hobbyhash.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\HobbyHash
    // macOS: ~/Library/Application Support/HobbyHash
    // Unix-like: ~/.hobbyhash
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "HobbyHash";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/HobbyHash";
#else
    // Unix-like
    return pathRet / ".hobbyhash";
#endif
#endif
}
