...
static constexpr auto MAX_DIGITS_HOBC = 16;
...
{
    switch (unit) {
    case Unit::BTC: return QString("HOBC");
    case Unit::mBTC: return QString("mHOBC");
    case Unit::uBTC: return QString::fromUtf8("µHOBC (bits)");
...
{
    switch (unit) {
    case Unit::BTC: return QString("HobbyHash Coin");
    case Unit::mBTC: return QString("Milli-HOBC (1 / 1" THIN_SP_UTF8 "000)");
    case Unit::uBTC: return QString("Micro-HOBC (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
...
QString BitcoinUnits::format(Unit unit, const CAmount& nIn, bool fPlus, SeparatorStyle separators, bool justify)
{
    ...
    if (justify) {
        quotient_str = quotient_str.rightJustified(MAX_DIGITS_HOBC - num_decimals, ' ');
    }
