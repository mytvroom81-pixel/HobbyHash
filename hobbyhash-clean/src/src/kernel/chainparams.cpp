...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000000a746a8a7dba5237b7f9c92cb1b2690cb53ab2958ce76a506b1ea96af"));
        assert(genesis.hashMerkleRoot == uint256S("0xbe535086a84506c2fb39f8e77a3065d5005d3a9b2ebcc9c1e3aa3162103b3f12"));
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000b0c1e63758239b91207c27a9e62636a2d6b3bc3680eb00f13634e33c"));
        assert(genesis.hashMerkleRoot == uint256S("0xbe535086a84506c2fb39f8e77a3065d5005d3a9b2ebcc9c1e3aa3162103b3f12"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x00000000a746a8a7dba5237b7f9c92cb1b2690cb53ab2958ce76a506b1ea96af")},
            }
        };
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x703694a35a5a93e7c9250ebad17deadbd5a15f2d8d3c998b8e5f632b59ec6f80"));
        assert(genesis.hashMerkleRoot == uint256S("0xbe535086a84506c2fb39f8e77a3065d5005d3a9b2ebcc9c1e3aa3162103b3f12"));
        ...
        checkpointData = {
            {
                {0, uint256S("0x00000000b0c1e63758239b91207c27a9e62636a2d6b3bc3680eb00f13634e33c")},
            }
        };
